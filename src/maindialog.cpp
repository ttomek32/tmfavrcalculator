...
bool MainDialog::ReLoadAVRDudeConf()
{
    ...
    if(fi.exists())
    {
        ...
        DisableTabs(false);                           //Œcie¿ka do AVRDude prawid³owa, mo¿na odblokowaæ zak³adki
    ...
    } else
    {
        ...
        if(splash) splash->hide();   //Ukryj splash screen jeœli jest, ¿eby poni¿szy komunikat nie by³ pod nim
...
void MainDialog::AVRDudeSetPath()
{
    ...
    ReLoadAVRDudeConf();                        //Prze³aduj konfiguracjê AVRDude
}
